        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="flex items-start space-x-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#D56649]/10 flex items-center justify-center">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Phone Number</h3>
                <p className="text-gray-600 dark:text-gray-300">
                  +234 (0)703 668 5502
                </p>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  onBlur={handleBlur}
                  required
                  className={`w-full px-4 py-3 rounded-lg bg-gray-50 dark:bg-gray-800 border transition-colors duration-200
                    ${errors.name 
              ...
              <motion.button
                ...
                className={`w-full px-8 py-4 rounded-lg bg-[#D56649] text-white font-semibold shadow-lg 
